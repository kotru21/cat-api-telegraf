...
function Xn(e) {
  let t = j.indexOf(e);
  t !== -1 && t > Re && j.splice(t, 1);
}
function Zn() {
  !ke && !$e && (($e = !0), queueMicrotask(Qn));
}
function Qn() {
  (($e = !1), (ke = !0));
  for (let e = 0; e < j.length; e++) (j[e](), (Re = e));
  ((j.length = 0), (Re = -1), (ke = !1));
}
var q,
  z,
  J,
...
function ir(e) {
  for (e._x_effects?.forEach(Xn); e._x_cleanups?.length; ) e._x_cleanups.pop()();
}
var Xe = new MutationObserver(tt),
  Ze = !1;
function Qe() {
  (Xe.observe(document, { subtree: !0, childList: !0, attributes: !0, attributeOldValue: !0 }),
    (Ze = !0));
}
function Bt() {
  (sr(), Xe.disconnect(), (Ze = !1));
}
var Z = [];
function sr() {
  let e = Xe.takeRecords();
  Z.push(() => e.length > 0 && tt(e));
  let t = Z.length;
  queueMicrotask(() => {
...
function tt(e) {
  ...
  for (let s of n) t.some((a) => a.contains(s)) || Lt.forEach((a) => a(s));
  for (let s of t) s.isConnected && Nt.forEach((a) => a(s));
...
var lr = {
  ...
  get({ objects: e }, t, n) {
    return t == 'toJSON' ? cr : Reflect.get(e.find((r) => Reflect.has(r, t)) || {}, t, n);
  },
  set({ objects: e }, t, n, r) {
...
function Vt(e, t) {
  ...
  je(n, e);
  let r = [n, ...U(e)],
    i = typeof t == 'function' ? gr(r, t) : yr(r, t, e);
  return dr.bind(null, e, t, i);
}
function gr(e, t) {
  return (n = () => {}, { scope: r = {}, params: i = [], context: s } = {}) => {
    let a = t.apply(ae([r, ...e]), i);
    me(n, a);
  };
}
var Oe = {};
  ...
  let n = Object.getPrototypeOf(async function () {}).constructor,
    ...
    s = (() => {
      try {
        ...
        return (ie(a, t, e), Promise.resolve());
      }
    })();
  return ((Oe[e] = s), s);
}
function yr(e, t, n) {
  ...
  return (i = () => {}, { scope: s = {}, params: a = [], context: o } = {}) => {
    ...
    if (typeof r == 'function') {
      let c = r.call(o, r, l).catch((u) => ie(u, n, t));
      r.finished
        ? (me(i, r.result, l, a, n), (r.result = void 0))
        : c
            .then((u) => {
              me(i, u, l, a, n);
            })
...
function me(e, t, n, r, i) {
  if (he && typeof t == 'function') {
    let s = t.apply(n, r);
    s instanceof Promise ? s.then((a) => me(e, a, n, r)).catch((a) => ie(a, i, t)) : e(s);
...
function rt(e, t, n) {
  if (((t = Array.from(t)), e._x_virtualDirectives)) {
    let s = Object.entries(e._x_virtualDirectives).map(([o, l]) => ({ name: o, value: l })),
      a = Yt(s);
    ((s = s.map((o) =>
...
function Xt(e) {
  ...
  return (
    t.push(i),
    [
      { Alpine: oe, effect: r, cleanup: n, evaluateLater: b.bind(b, e), evaluate: D.bind(D, e) },
      () => t.forEach((o) => o()),
    ]
  );
}
function wr(e, t) {
  ...
  let a = () => {
    e._x_ignore ||
      e._x_ignoreSelf ||
      (r.inline && r.inline(e, t, i), (r = r.bind(r, e, t, i)), De ? te.get(Gt).push(r) : r());
  };
...
function en(e = () => {}) {
  return ({ name: t, value: n }) => {
    let { name: r, value: i } = tn.reduce((s, a) => a(s), { name: t, value: n });
...
function Sr(e, t) {
  let n = N.indexOf(e.type) === -1 ? Fe : e.type,
    r = N.indexOf(t.type) === -1 ? Fe : t.type;
...
function Ar() {
  ...
  (Array.from(document.querySelectorAll(on().join(',')))
    .filter(e)
    .forEach((t) => {
      M(t);
    }),
...
function ve(e, t = !1) {
  return Y(e, (n) => {
    if ((t ? on() : an()).some((i) => n.matches(i))) return !0;
  });
}
function Y(e, t) {
  if (e) {
    ...
    br(() => {
      t(e, (r, i) => {
        r._x_marker ||
          (n(r, i),
          un.forEach((s) => s(r, i)),
          rt(r, r.attributes).forEach((s) => s()),
          r._x_ignore || (r._x_marker = Mr++),
          r._x_ignore && i());
      });
    });
}
...
function Tr() {
  [
    ...
    vr(n) ||
      r.some((i) => {
        if (document.querySelector(i)) return (S(`found "${i}", but missing ${t} plugin`), !0);
      });
  });
}
var Be = [],
...
function be(e, t) {
  return typeof t == 'object' && t !== null ? $r(e, t) : kr(e, t);
}
function $r(e, t) {
  let n = {};
  return (
    Object.entries(t).forEach(([r, i]) => {
      ((n[r] = e.style[r]), r.startsWith('--') || (r = Rr(r)), e.style.setProperty(r, i));
    }),
    setTimeout(() => {
...
x('transition', (e, { value: t, modifiers: n, expression: r }, { evaluate: i }) => {
  (typeof r == 'function' && (r = i(r)),
    r !== !1 && (!r || typeof r == 'boolean' ? Nr(e, n, t) : Lr(e, r, t)));
});
function Lr(e, t, n) {
  (fn(e, lt, ''),
    {
...
function Nr(e, t, n) {
  ...
  (t.includes('in') && !r && (t = t.filter((g, y) => y < t.indexOf('out'))),
    t.includes('out') && !r && (t = t.filter((g, y) => y > t.indexOf('out'))));
  let a = !t.includes('opacity') && !t.includes('scale'),
    o = a || t.includes('opacity'),
    l = a || t.includes('scale'),
    c = o ? 0 : 1,
    u = l ? Q(t, 'scale', 95) / 100 : 1,
    p = Q(t, 'delay', 0) / 1e3,
    f = Q(t, 'origin', 'center'),
    _ = 'opacity, transform',
    w = Q(t, 'duration', 150) / 1e3,
    le = Q(t, 'duration', 75) / 1e3,
...
function fn(e, t, n = {}) {
  e._x_transition ||
    (e._x_transition = {
      ...
      in(r = () => {}, i = () => {}) {
        He(e, t, { during: this.enter.during, start: this.enter.start, end: this.enter.end }, r, i);
      },
      out(r = () => {}, i = () => {}) {
        He(e, t, { during: this.leave.during, start: this.leave.start, end: this.leave.end }, r, i);
      },
    });
}
...
function He(e, t, { during: n, start: r, end: i } = {}, s = () => {}, a = () => {}) {
  if (
...
function zr(e, t) {
  if (xn(e))
    (e.attributes.value === void 0 && (e.value = t),
      window.fromModel &&
        (typeof t == 'boolean' ? (e.checked = _e(e.value) === t) : (e.checked = bt(e.value, t))));
  else if (ct(e))
    Number.isInteger(t)
      ? (e.value = t)
      : !Array.isArray(t) && typeof t != 'boolean' && ![null, void 0].includes(t)
        ? (e.value = String(t))
        : Array.isArray(t)
          ? (e.checked = t.some((n) => bt(n, e.value)))
          : (e.checked = !!t);
  else if (e.tagName === 'SELECT') Vr(e, t);
  else {
    if (e.value === t) return;
    e.value = t === void 0 ? '' : t;
  }
...
function gn(e, t, n) {
  [null, void 0, !1].includes(n) && Xr(t) ? e.removeAttribute(t) : (mn(t) && (n = t), qr(e, t, n));
}
function qr(e, t, n) {
...
function Qr(e, t, n, r = !0) {
  ...
  if (e._x_inlineBindings && e._x_inlineBindings[t] !== void 0) {
    ...
    return ((i.extract = r), qt(() => D(e, i.expression)));
  }
  return yn(e, t, n);
}
function yn(e, t, n) {
...
var L = {},
  wt = !1;
function ti(e, t) {
  if ((wt || ((L = q(L)), (wt = !0)), t === void 0)) return L[e];
  ((L[e] = t),
    zt(L[e]),
    typeof t == 'object' &&
      t !== null &&
...
var oi = {
    ...
    setReactivityEngine: tr,
    onAttributeRemoved: Dt,
...
var ci = Object.freeze({}),
  ...
  Cn = (e) => di.call(e),
  On = (e) => Cn(e).slice(8, -1),
  ft = (e) => fi(e) && e !== 'NaN' && e[0] !== '-' && '' + parseInt(e, 10) === e,
  pi = (e) => {
    const t = Object.create(null);
    return (n) => t[n] || (t[n] = e(n));
  },
  hi = pi((e) => e.charAt(0).toUpperCase() + e.slice(1)),
  Mn = (e, t) => e !== t && (e === e || t === t),
  We = new WeakMap(),
  ee = [],
  O,
...
function xi(e, t) {
  const n = function () {
    ...
    if (!ee.includes(n)) {
      Tn(n);
      try {
        return (bi(), ee.push(n), (O = n), e());
      } finally {
        (ee.pop(), Pn(), (O = ee[ee.length - 1]));
      }
    }
  };
  return (
...
function $(e, t, n, r, i, s) {
  ...
  if (t === 'clear') a.forEach(l);
    ...
    switch ((n !== void 0 && l(a.get(n)), t)) {
      case 'add':
        F(e) ? ft(n) && l(a.get('length')) : (l(a.get(B)), re(e) && l(a.get(qe)));
        break;
      case 'delete':
        F(e) || (l(a.get(B)), re(e) && l(a.get(qe)));
        break;
      case 'set':
        re(e) && l(a.get(B));
        break;
...
var wi = li('__proto__,__v_isRef,__isVue'),
  In = new Set(
...
function Ai() {
  ...
  return (
    ['includes', 'indexOf', 'lastIndexOf'].forEach((t) => {
      e[t] = function (...n) {
        const r = h(this);
        for (let s = 0, a = this.length; s < a; s++) A(r, 'get', s + '');
        const i = r[t](...n);
...
function $n(e = !1, t = !1) {
  return function (r, i, s) {
    ...
    if (i === '__v_raw' && s === (e ? (t ? Fi : Nn) : t ? Di : Ln).get(r)) return r;
    const a = F(r);
    if (!e && a && Ee(Et, i)) return Reflect.get(Et, i, s);
    const o = Reflect.get(r, i, s);
    return (ut(i) ? In.has(i) : wi(i)) || (e || A(r, 'get', i), t)
      ? o
      : Je(o)
        ? !a || !ft(i)
          ? o.value
...
function Oi(e = !1) {
  return function (n, r, i, s) {
    let a = n[r];
    if (!e && ((i = h(i)), (a = h(a)), !F(n) && Je(a) && !Je(i))) return ((a.value = i), !0);
    const o = F(n) && ft(r) ? Number(r) < n.length : Ee(n, r),
      l = Reflect.set(n, r, i, s);
    return (n === h(s) && (o ? Mn(i, a) && $(n, 'set', r, i, a) : $(n, 'add', r, i)), l);
  };
}
function Mi(e, t) {
  const n = Ee(e, t),
...
function Pi(e) {
  return (A(e, 'iterate', F(e) ? 'length' : B), Reflect.ownKeys(e));
}
var Ii = { get: Ei, set: Ci, deleteProperty: Mi, has: Ti, ownKeys: Pi },
  $i = {
    get: Si,
    set(e, t) {
      return (
...
function fe(e, t = !1) {
  return ((e = e.__v_raw), !t && A(h(e), 'iterate', B), Reflect.get(e, 'size', e));
}
function St(e) {
  e = h(e);
  const t = h(this);
...
function At(e, t) {
  ...
  const n = h(this),
    { has: r, get: i } = Ae(n);
  let s = r.call(n, e);
  s ? Rn(n, r, e) : ((e = h(e)), (s = r.call(n, e)));
  const a = i.call(n, e);
  return (n.set(e, t), s ? Mn(t, a) && $(n, 'set', e, t, a) : $(n, 'add', e, t), this);
}
function Ct(e) {
  const t = h(this),
    { has: n, get: r } = Ae(t);
  let i = n.call(t, e);
  i ? Rn(t, n, e) : ((e = h(e)), (i = n.call(t, e)));
  const s = r ? r.call(t, e) : void 0,
    a = t.delete(e);
  return (i && $(t, 'delete', e, void 0, s), a);
}
function Ot() {
  const e = h(this),
    t = e.size !== 0,
...
function de(e, t) {
  return function (r, i) {
    const s = this,
      ...
      o = h(a),
      l = t ? _t : e ? ht : pt;
    return (!e && A(o, 'iterate', B), a.forEach((c, u) => r.call(i, l(c), l(u), s)));
  };
}
function pe(e, t, n) {
  return function (...r) {
    const i = this.__v_raw,
      ...
      u = n ? _t : t ? ht : pt;
    return (
      !t && A(s, 'iterate', l ? qe : B),
      {
        next() {
          const { value: p, done: f } = c.next();
          return f ? { value: p, done: f } : { value: o ? [u(p[0]), u(p[1])] : u(p), done: f };
        },
        [Symbol.iterator]() {
          return this;
        },
  ...
  return function (...t) {
    {
      ...
      console.warn(`${hi(e)} operation ${n}failed: target is readonly.`, h(this));
    }
...
function Ki(e) {
  return e.__v_skip || !Object.isExtensible(e) ? 0 : Bi(On(e));
}
function gt(e) {
  return e && e.__v_isReadonly ? e : Dn(e, !1, Ii, Ni, Ln);
}
function jn(e) {
  return Dn(e, !0, $i, ji, Nn);
}
...
C('data', (e) => Kt(e));
C('root', (e) => ve(e));
C('refs', (e) => (e._x_refs_proxy || (e._x_refs_proxy = ae(zi(e))), e._x_refs_proxy));
function zi(e) {
  let t = [];
  return (
    Y(e, (n) => {
...
function Ve(e, t, n, r) {
  ...
  if (
    ...
    let l = n[n.indexOf('debounce') + 1] || 'invalid-wait',
      c = xe(l.split('ms')[0]) ? Number(l.split('ms')[0]) : 250;
    s = vn(s, c);
  }
...
function Xi(e, t) {
  ...
  if (n.length === 0 || (n.length === 1 && Tt(e.key).includes(n[0]))) return !1;
  ...
  return (
    ...
    !(
      ...
      i.filter((a) => ((a === 'cmd' || a === 'super') && (a = 'meta'), e[`${a}Key`])).length ===
        i.length &&
      (zn(e.type) || Tt(e.key).includes(n[0]))
    )
  );
}
function Tt(e) {
...
x('model', (e, { modifiers: t, expression: n }, { effect: r, cleanup: i }) => {
  ...
  let a = b(s, n),
    o;
  typeof n == 'string'
    ? (o = b(s, `${n} = __placeholder`))
    : typeof n == 'function' && typeof n() == 'string'
      ? (o = b(s, `${n()} = __placeholder`))
      : (o = () => {});
  let l = () => {
      let f;
      return (a((_) => (f = _)), Pt(f) ? f.get() : f);
    },
    c = (f) => {
      let _;
      (a((w) => (_ = w)), Pt(_) ? _.set(f) : o(() => {}, { scope: { __placeholder: f } }));
    };
  typeof n == 'string' &&
    e.type === 'radio' &&
    m(() => {
  ...
  if (
    ...
    let f = Ve(e.form, 'reset', [], (_) => {
      ot(() => e._x_model && e._x_model.set(Pe(e, t, { target: e }, l())));
    });
    i(() => f());
  }
  ((e._x_model = {
  ...
  return m(() => {
    ...
    if (ct(e))
        ...
        return (
          t.includes('number')
            ...
            : t.includes('boolean')
              ? (i = _e(n.target.value))
              : (i = n.target.value),
          n.target.checked ? (r.includes(i) ? r : r.concat([i])) : r.filter((s) => !Zi(s, i))
        );
            ...
            : Array.from(n.target.selectedOptions).map((i) => i.value || i.text);
      {
        let i;
        return (
          xn(e) ? (n.target.checked ? (i = n.target.value) : (i = r)) : (i = n.target.value),
          t.includes('number')
            ? Ie(i)
            : t.includes('boolean')
              ? _e(i)
...
x('cloak', (e) => queueMicrotask(() => m(() => e.removeAttribute(V('cloak')))));
cn(() => `[${V('init')}]`);
x(
  'init',
...
it(Zt(':', Qt(V('bind:'))));
var Hn = (e, { value: t, modifiers: n, expression: r, original: i }, { effect: s, cleanup: a }) => {
  if (!t) {
    let l = {};
    (ii(l),
      b(e, r)(
...
function ts(e) {
  return I ? (Ue ? !0 : e.hasAttribute('data-has-alpine-state')) : !1;
}
x('show', (e, { modifiers: t, expression: n }, { effect: r }) => {
    ...
    l = ze(
      ...
      (p) => {
        typeof e._x_toggleAndCascadeWithTransitions == 'function'
          ? e._x_toggleAndCascadeWithTransitions(e, p, a, s)
          : p
            ? o()
            : s();
      },
  ...
  r(() =>
    i((p) => {
      (!u && p === c) || (t.includes('immediate') && (p ? o() : s()), l(p), (c = p), (u = !1));
    }),
  );
});
...
function ns(e, t, n, r) {
  let i = (a) => typeof a == 'object' && !Array.isArray(a),
    s = e;
  n((a) => {
    (is(a) && a >= 0 && (a = Array.from(Array(a).keys(), (d) => d + 1)), a === void 0 && (a = []));
    let o = e._x_lookup,
      l = e._x_prevKeys,
      c = [],
      u = [];
    if (i(a))
      a = Object.entries(a).map(([d, g]) => {
        ...
        (r(
          (v) => {
            (u.includes(v) && S('Duplicate key on x-for', e), u.push(v));
          },
          { scope: { index: d, ...y } },
        ),
          c.push(y));
    ...
    for (let d = 0; d < l.length; d++) {
      let g = l[d];
      u.indexOf(g) === -1 && _.push(g);
    }
    l = l.filter((d) => !_.includes(d));
    let le = 'template';
    for (let d = 0; d < u.length; d++) {
      let g = u[d],
        y = l.indexOf(g);
      if (y === -1) (l.splice(d, 0, g), p.push([le, d]));
      else if (y !== d) {
        let v = l.splice(d, 1)[0],
          E = l.splice(y - 1, 1)[0];
        (l.splice(d, 0, E), l.splice(y, 0, v), f.push([v, E]));
      } else w.push(g);
      le = g;
    }
    ...
    for (let d = 0; d < f.length; d++) {
      ...
      (m(() => {
        (E || S('x-for ":key" is undefined or invalid', s, y, o),
          E.after(H),
          v.after(E),
        ...
        E._x_refreshXForScope(c[u.indexOf(y)]));
    }
    for (let d = 0; d < p.length; d++) {
      ...
      let E = c[y],
        ...
        mt = q(E);
      (se(X, mt, s),
        (X._x_refreshXForScope = (qn) => {
          Object.entries(qn).forEach(([Jn, Vn]) => {
            mt[Jn] = Vn;
          });
        }),
        m(() => {
        ...
        typeof H == 'object' &&
          S('x-for key cannot be an object, it must be a string or an integer', s),
        (o[H] = X));
    }
    for (let d = 0; d < w.length; d++) o[w[d]]._x_refreshXForScope(c[u.indexOf(w[d])]);
    s._x_prevKeys = u;
  });
}
function rs(e) {
...
oe.setEvaluator(Vt);
oe.setReactivityEngine({ reactive: gt, effect: gi, release: mi, raw: h });
var ss = oe,
  T = ss;
const Ye = new Map(),
  Wn = 15e3;
function as(e, t, n = Wn) {
  Ye.set(e, { ts: Date.now(), ttl: n, data: t });
}
function os(e) {
  const t = Ye.get(e);
  return t ? (Date.now() - t.ts > t.ttl ? (Ye.delete(e), null) : t.data) : null;
}
async function R(e, t = {}) {
  const {
      ...
      cache: s = !1,
      ttl: a,
      credentials: o = 'include',
    } = t,
    l = s ? `${n}:${e}:${i ? JSON.stringify(i) : ''}` : null;
  if (s && l) {
    const f = os(l);
    if (f) return f;
  }
  const c = { method: n, headers: { Accept: 'application/json', ...r }, credentials: o };
  i &&
    ((c.headers['Content-Type'] = 'application/json'),
    (c.body = typeof i == 'string' ? i : JSON.stringify(i)));
  let u;
  try {
    u = await fetch(e, c);
  } catch (f) {
    const _ = f instanceof Error ? f.message : String(f);
    throw new Error(`NETWORK_ERROR:${_}`);
  }
  if (!u.ok) {
    let f = null;
    try {
    ...
    const _ = f?.error || f?.message || `HTTP ${u.status}`,
      w = new Error(_);
    throw ((w.status = u.status), (w.payload = f), w);
  }
  ...
  try {
    ...
    const _ = f instanceof Error ? f.message : String(f);
    throw new Error(`INVALID_JSON_RESPONSE:${_}`);
  }
  return (s && l && as(l, p, a ?? Wn), p);
}
const ls = () => R('/api/leaderboard', { cache: !0 }),
  cs = (e = 3) => R(`/api/random-images?count=${e}`, { cache: !1 }),
  us = () => R('/api/profile', { cache: !1 }),
  fs = () => R('/api/mylikes', { cache: !1 }),
  ds = (e) => R('/api/like', { method: 'POST', body: { catId: e } }),
  ps = (e) => R('/api/like', { method: 'DELETE', body: { catId: e } }),
  hs = (e) => R(`/api/cat/${encodeURIComponent(e)}`, { cache: !0, ttl: 6e4 }),
  _s = (e, t) =>
    R(`/api/similar?feature=${encodeURIComponent(e)}&value=${encodeURIComponent(t)}`, {
      cache: !1,
    });
function gs(e = '/wss') {
...
function ms(e) {
  ...
  return {
    days: { value: String(r), label: 'дн.' },
    hours: { value: String(i), label: 'ч.' },
    minutes: { value: String(s), label: 'мин.' },
    seconds: { value: String(a), label: 'сек.' },
  };
}
T.store('global', {
  user: null,
...
T.data('catDetails', (e) => ({
  ...
  async toggleLike() {
    if (!(this.likeLocked || !this.cat)) {
      ((this.likeLocked = !0), this.likesCount++);
      try {
        await ds(this.cat.id);
      } catch (t) {
        (this.likesCount--, console.error('Failed to like:', t));
      }
      setTimeout(() => {
        this.likeLocked = !1;
      }, 400);
  ...
  navigateSimilar(t, n) {
    let r = n;
    if (t === 'weight_metric') {
      const i = n.match(/\(([0-9. -]+)кг\)/);
      if (i && i[1]) {
        const a = i[1].match(/\d+(\.\d+)?/g);
        if (a && a.length >= 2) {
          const o = parseFloat(a[0]),
            l = parseFloat(a[1]);
          r = ((o + l) / 2).toFixed(1);
        } else a && a.length === 1 && (r = a[0]);
      } else {
        const s = n.match(/\d+(\.\d+)?/g);
        if (s && s.length >= 2) {
          const a = parseFloat(s[0]),
            o = parseFloat(s[1]);
          r = ((a + o) / 2).toFixed(1);
        }
      }
    } else t === 'temperament' && (r = n.split(',')[0].trim());
    window.location.href = `/similar.html?feature=${t}&value=${encodeURIComponent(r)}`;
  },
}));
T.data('similarCats', () => ({
  cats: [],
  ...
  async init() {
    ...
    ((this.featureName = this.FEATURE_NAMES[t] || t),
      (this.searchValue = n),
      (document.title = `Поиск по ${this.featureName}: ${n} | CatBot`),
      (this.loading = !0));
    try {
      const r = await _s(t, n);
      ...
      (console.error('similar load error', r),
  ...
  updatePage(e) {
    ...
    this.currentPage = e;
    const t = (e - 1) * this.pageSize;
    ((this.displayedCats = this.cats.slice(t, t + this.pageSize)),
      window.scrollTo({ top: 0, behavior: 'smooth' }));
  },
  get pages() {
    const e = [];
    for (
      let n = Math.max(2, this.currentPage - 2);
      n <= Math.min(this.totalPages - 1, this.currentPage + 2);
      n++
    )
      e.push(n);
    return (
      this.currentPage - 2 > 2 && e.unshift('...'),
      this.currentPage + 2 < this.totalPages - 1 && e.push('...'),
      e.unshift(1),
      this.totalPages > 1 && e.push(this.totalPages),
      e
    );
  },
}));
...
T.data('stats', () => ({
  ...
  connect() {
    ((this.ws = new WebSocket(gs())),
      (this.ws.onmessage = (e) => {
        this.loading = !1;
        try {
          const { messageCount: t, uptimeDateObject: n } = JSON.parse(e.data);
          if ((t != null && (this.messageCount = t), n)) {
            const r = new Date(n);
            this.interval && window.clearInterval(this.interval);
            const i = () => {
              this.uptime = ms(r);
            };
            (i(), (this.interval = window.setInterval(i, 1e3)));
          }
        } catch (t) {
          console.error('Invalid WS payload', t);
        }
      }),
      (this.ws.onerror = () => {
        ((this.loading = !1), (this.messageCount = 'Ошибка'));
      }),
      (this.ws.onclose = () => {}));
  },
  destroy() {
    (this.interval && window.clearInterval(this.interval), this.ws && this.ws.close());
  },
}));
T.data('navigation', () => ({
  mobileMenuOpen: !1,
...
T.data('profile', () => ({
  ...
  async init() {
    ...
    try {
      ...
      ((this.error = e instanceof Error ? e.message : String(e)), (this.likes = []));
    } finally {
      this.loading = !1;
    }
  },
  get filteredLikes() {
    ...
    return this.likes.filter((t) => (t.breeds?.[0]?.name || '').toLowerCase().includes(e));
  },
  confirmDelete(e) {
    ((this.catToDelete = e), (this.confirmModalOpen = !0));
  },
  async deleteLike() {
    if (!this.catToDelete) return;
    const e = this.catToDelete.id;
    this.confirmModalOpen = !1;
    const t = [...this.likes];
    this.likes = this.likes.filter((n) => n.id !== e);
    try {
      (await ps(e), (this.catToDelete = null));
    } catch (n) {
      ((this.likes = t), alert('Не удалось удалить лайк'), console.error(n));
    }
  },
}));
T.start();
